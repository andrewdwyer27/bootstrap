  ...
  return (
    <div className="w-full h-auto flex">
      <div className="h-44 w-3/6 mt-20 flex flex-col items-center">
        ...
        <p className="text-grayfont w-3/6 text-center">Empower kids with exceptional coding tutor, unlocking mastery through innovative, impressive projects. Ignite potential!</p>
      </div>
