...
export default function MiddleBar() {
    return (
        <div className="bg-primary-green h-44 flex justify-center mt-10">
            <div className="border-r-8 w-3/12 h-44 flex flex-col justify-center">
            ...
            <div className="w-3/12 h-44 flex flex-col justify-center">
